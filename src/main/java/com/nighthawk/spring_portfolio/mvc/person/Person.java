...
public class Person {
    ...
    */
    ...
    public Person(String email, String password, String name, Date dob, int height, String eyecolor, Boolean handedness) {
        this.email = email;
    ...
    public static void main(String[] args) throws ParseException{
        ...
        Date myDate = sdf.parse("2006-02-12");

        Person person = new Person("thisisfake@ifyoufoundthisyouprobablyhavemyemailalready.lol", "password", "Sophie Park", myDate, 64, "brown", true);
