...
public class PersonApiController {
    ...
    */
    ...
    @GetMapping("/getEyeColor/{id}")
    public String getEyeColor(@PathVariable long id) {
        Optional<Person> optional = repository.findById(id);
        if (optional.isPresent()) {  // Good ID
            Person person = optional.get();  // value from findByID
            return person.getEyeColorToString();
        }
        return null;       
    }
    /*
    ...
    public ResponseEntity<Object> postPerson(@RequestParam("email") String email,
                                             ...
                                             @RequestParam("handedness") Boolean handedness) {
        Date dob;
        try {
        ...
        Person person = new Person(email, password, name, dob, height, eyecolor, handedness);
    ...
    */
    @PostMapping(value = "/setStats", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
